# File: multi_doc_chat_final.py
"""
MULTI-DOCUMENT REAL-TIME CONVERSATION SYSTEM - PLUG & PLAY
Cross-document chat with PDF and TXT support
"""
...
class MultiDocumentProcessor:
            ...
            if os.path.isfile(file_path):
                ...
                if ext in supported_extensions:
                    try:
                        ...
                        print(f"  ✗ Error loading {file}: {str(e)[:50]}")
    ...
    def _extract_pdf_text(self, pdf_path: str) -> str:
        ...
        try:
            ...
            print(f"  ⚠️ PDF error {os.path.basename(pdf_path)}: {str(e)[:50]}")
            return ""
    ...
    def _build_cross_document_references(self):
        ...
        for keyword, doc_list in all_keywords.items():
            if len(doc_list) > 1:  # Keyword appears in multiple documents
                # Store a TUPLE of (keyword, 'keyword', frozenset(doc_list))
...
class DocumentChatInterface:
    ...
    def display_banner(self):
        ...
        print("\n" + "=" * 70)
        print("💬 MULTI-DOCUMENT INTELLIGENT CONVERSATION - PLUG & PLAY")
        print("=" * 70)
        print("\n📚 Features:")
...
def main():
    """Main entry point"""
    print("\n" + "=" * 70)
    print("🚀 CROSS-DOCUMENT CONVERSATION SYSTEM - PLUG & PLAY")
    print("=" * 70)
